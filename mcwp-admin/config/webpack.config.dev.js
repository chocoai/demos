...
const CaseSensitivePathsPlugin = require('case-sensitive-paths-webpack-plugin'); // 在 Webpack 中强制模块路径区分大小写
...
// const bundleConfig = require("../public/tmp/bundle-config.json");
...
module.exports = {
  ...
  plugins: [
    ...
    //     manifest: require('../public/tmp/bundle.manifest.json')
    // }),
