 ...
 */
class DetailFarmSoft extends Component {
        constructor(props) {
        super(props);
        this.state = {
    ...
    componentWillMount() {
        ...
        let {age,marriage,familyrelationship,businessconcerns,socialcommunication,assetsaccumulation,creditrecord,operatingcondition} = this.props.sigleSoftInfo;
        this.setState({
            arrItem: [softInfo.nl,softInfo.hy,softInfo.jtgx,softInfo.sygzd,softInfo.shjw,softInfo.zcjl,softInfo.xyjl,softInfo.jyqk],
            arrClass: [age,marriage,familyrelationship,businessconcerns,socialcommunication,assetsaccumulation,creditrecord,operatingcondition],
            description: ['年龄','婚姻','家庭关系','生意关注度','社会交往','资产积累','信用记录','经营情况'],
        })
    }
    render() {
...
const pureDetailFarmSoft = pureRender(DetailFarmSoft);

export default pureDetailFarmSoft;
