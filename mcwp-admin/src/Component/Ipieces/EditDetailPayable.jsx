 ...
 */
class EditDetailPayable extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arr: [...Array(props.len + 1 || 1)].map((_, i)=> i),
            max: props.len + 1 || 1,
            assetTotal: props.payableData.assetTotal || '0'
        }
    }
                ...
                <Form>
                    <div className='editDetail-top'>
                        <div className='editDetail-top-content editDetail-top-fixed'>
                            <FormItem>
                                {getFieldDecorator('assetPay.assetTotal', {
                                    initialValue: payableData.assetTotal || '0',
                                    rules: [{ required: false }],
                                })(
                                    <input className='editDetail-top-input' style={{display:'none'}} placeholder='请输入' />
                                )}
                            </FormItem>
                            <p>应付账款总额：{this.state.assetTotal || '0'}</p>
                            <p>元</p>
                        </div>
                        <div className='editDetail-top-content'>
                            <p>应付款与月营业额占比：</p>
                            <FormItem>
                                {getFieldDecorator('assetPay.exRatio', {
                                    initialValue: payableData.exRatio || '',
                                    rules: [{ required: false }],
                                })(
                        ...
                        <table className='finance-table'>
                            <thead>
                                <tr className='finance-head'>
                                    ...
                                    <th className='finance-head-first'>应付款占比（%）</th>
                                    <th className='finance-head-first'>应付款金额（元）</th>
                                    {/*<th className='finance-head-first'>交易内容</th>*/}
                                    {/*<th className='finance-head-first'>应付账款发生日期</th>*/}
                                    ...
                                    this.state.arr.map((item, index) => (
                                        <tr key = {item}>
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].cname', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].cname || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].ratio', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].ratio || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].amount', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].amount || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].inBusiness', {
                                                        initialValue: payableData.assetInfoDTOS[item] && (payableData.assetInfoDTOS[item].inBusiness == 0 || payableData.assetInfoDTOS[item].inBusiness == 1) && payableData.assetInfoDTOS[item].inBusiness.toString() || '',
                                                        rules: [{ required: false }],
                                                    })(
                                                        <Select
                                                            placeholder="请选择"
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].averageAmount', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].averageAmount || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPay.assetInfoDTOS['+ item +'].turnoverPreMonth', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].turnoverPreMonth || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            {/*<td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetInfoDTOS['+ item +'].remark', {
                                                        initialValue: payableData.assetInfoDTOS[item] && payableData.assetInfoDTOS[item].remark || '',
                                                        rules: [{ required: false }],
                                                    })(
                                                        <input className='finance-input' autoComplete="off" placeholder="请输入" ref={cname => {this['expectSettleDate' + item ] = cname}} onChange={()=>this.changeTable(index)} />
                                                    )}
...
const pureEditDetailPayable = pureRender(EditDetailPayable);

export default pureEditDetailPayable;
