 ...
 */
class EditDetailPrePay extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arr: [...Array(props.len + 1 || 1)].map((_, i)=> i),
            max: props.len + 1 || 1,
            assetTotal: props.prePayData.assetTotal || '0'
        }
    }
                ...
                <Form>
                    <div className='editDetail-top'>
                        <div className='editDetail-top-content editDetail-top-fixed'>
                            <FormItem>
                                {getFieldDecorator('assetPrePay.assetTotal', {
                                    initialValue: prePayData.assetTotal || '0',
                        ...
                        <div className='editDetail-top-content'>
                            <p>预付款与月营业额占比：</p>
                            <FormItem>
                                {getFieldDecorator('assetPrePay.exRatio', {
                                    initialValue: prePayData.exRatio || '',
                                    rules: [{ required: false }],
                                })(
                        ...
                        <table className='finance-table'>
                            <thead>
                                <tr className='finance-head'>
                                    ...
                                    <th className='finance-head-first'>预付款占比（%）</th>
                                    <th className='finance-head-first'>预付款金额（元）</th>
                                    {/*<th className='finance-head-first'>交易内容</th>*/}
                                    {/*<th className='finance-head-first'>预付账款发生日期</th>*/}
                                    ...
                                    this.state.arr.map((item, index) => (
                                        <tr key = {item}>
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].cname', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].cname || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].ratio', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].ratio || '',
                                                        rules: [{ required: false }],
                                                    })(
                                                        <input className='finance-input' autoComplete="off" placeholder="请输入" ref={cname => {this['ratio' + item ] = cname}} onChange={(e)=>this.changeTable(e, index, 'amount')} />
                                                    )}
                                                </FormItem>
                                            </td>
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].amount', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].amount || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].inBusiness', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && (prePayData.assetInfoDTOS[item].inBusiness == 0 || prePayData.assetInfoDTOS[item].inBusiness == 1) && prePayData.assetInfoDTOS[item].inBusiness.toString() || '',
                                                        rules: [{ required: false }],
                                                    })(
                                                        <Select
                                                            placeholder="请选择"
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].averageAmount', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].averageAmount || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            <td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetPrePay.assetInfoDTOS['+ item +'].turnoverPreMonth', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].turnoverPreMonth || '',
                                                        rules: [{ required: false }],
                                                    })(
                                            ...
                                            {/*<td className='finance-table-content'>
                                                <FormItem>
                                                    {getFieldDecorator('assetInfoDTOS['+ item +'].remark', {
                                                        initialValue: prePayData.assetInfoDTOS[item] && prePayData.assetInfoDTOS[item].remark || '',
                                                        rules: [{ required: false }],
                                                    })(
                                                        <input className='finance-input' autoComplete="off" placeholder="请输入" onChange={()=>this.changeTable(index)} />
                                                    )}
...
const pureEditDetailPrePay = pureRender(EditDetailPrePay);

export default pureEditDetailPrePay;
