...
class EditLogic extends Component {
        ...
        this.state = {
            code: props.code,
            value:''
            // wordCount: props.logicData && props.logicData.costStructureOther?props.logicData.costStructureOther.length:0
        }
    }
    ...
    render() {
        ...
        const { logicData, linkTo, ipiecesType } = this.props;
        console.log(linkTo)
        return (
            <div className='editLogic-container'>
                <Form>
                <div className='ipieces-subtitle-container'>
                    <p className='ipieces-subtitle'>权益逻辑校验</p>
                ...
                <div className='ipieces-subtitle-container'>
                    <p className='ipieces-subtitle'>毛利率逻辑校验</p>
                    <Link className='ipieces-subtitle-check' onClick = {()=>linkTo(`/ipieces/edit/verify/profit/${code}/${ipiecesType}`)}>录入检验项</Link>
                </div>
                    <div className='ipieces-detail'>
                ...
                <div className='ipieces-subtitle-container'>
                    <p className='ipieces-subtitle'>销售额逻辑校验</p>
                    <Link className='ipieces-subtitle-check' onClick = {()=>linkTo(`/ipieces/edit/verify/sale/${code}/${ipiecesType}`)} >录入检验项</Link>
                </div>
                <div className='ipieces-detail'>
                ...
                <div className='ipieces-subtitle-container'>
                    <p className='ipieces-subtitle'>采购额逻辑校验</p>
                    <Link className='ipieces-subtitle-check' onClick = {()=>linkTo(`/ipieces/edit/verify/purchase/${code}/${ipiecesType}`)} >录入检验项</Link>
                </div>
                <div className='ipieces-detail'>
...
const pureEditLogic = pureRender(EditLogic);

export default pureEditLogic;
