 ...
 */
class FormApplyField extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fieldConf: [],
            ...
            defaultValue: '',       // 默认文本
            record: {},             // 当前编辑模块
            modalKey: 'FormApplyField',
            breadValue: JSON.parse(Config.localItem(Config.formConfLocal.formApplyConf)).filter(i => i.formEnName == props.routeParams.formEnName)[0].formChName
        };
    }
    ...
    render() {
        const {fieldConf, prdType, visible, modalKey, defaultValue, breadValue} = this.state
        const columns = [{
            title: '字段名称',
