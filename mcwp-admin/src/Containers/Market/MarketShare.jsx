...
class MarketShare extends Component {
    ...
    shareRule = () =>{
        browserHistory.push('/market/share/rule' );
    }
	render() {
        const { loading , shareInfo } = this.state
        ...
        return (
            <Spin tip={Config.warnInfo.spinText} spinning={loading}>
                <div className="common-console-container marketShare-container">
                    ...
                    <div className="date-search-container">
                        ...
                        <div className='search-item' data-flex="dir:left">
                            <Select
                                ...
                                <Option key={2} value='2'>进件</Option>
                                <Option key={3} value='3'>审批通过</Option>

                            </Select>
                        </div>
                        <Search placeholder="姓名" onSearch={this.searchData} className='search-item' ref='searchData' style={{ width: 180 }} />
                        <ResetSearch />
