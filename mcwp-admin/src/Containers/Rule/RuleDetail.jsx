...
class RuleDetail extends Component {
	...
	render() {
		const { loading, ruleDetail, code, procode, type, ruleText } = this.state;
		const bcrumb = [{
			'link': '/rule',
			'value': '规则配置'
		}, {
				...
				<div className="rule-content">
					...
					<Row className="row-title">
						...
						<Col span={3} className="rule-action">
							<Link className="rule-view" to={"/rule/bank/right/detail/" + code + '?code=' + procode + '&type=' + type}><Icon type="file-text" className='rule-icon' />查看规则</Link>
						</Col>
					</Row>
					...
					<Row className="row-title">
						...
						<Col span={3} className="rule-action">
							<Link className="rule-view" to={"/rule/bank/gross/detail/" + code + '?code=' + procode + '&type=' + type}><Icon type="file-text" className='rule-icon' />查看规则</Link>
						</Col>
					</Row>
					<Row className="row-content">
						<Col span={12} className="rule-p">
					...
					<Row className="row-title">
						...
						<Col span={3} className="rule-action">
							<Link className="rule-view" to={"/rule/bank/sale/detail/" + code + '?code=' + procode + '&type=' + type}><Icon type="file-text" className='rule-icon' />查看规则</Link>
						</Col>
					</Row>
					<Row className="row-content">
						<Col span={12} className="rule-p">
					...
					<Row className="row-title">
						...
						<Col span={3} className="rule-action">
							<Link className="rule-view" to={"/rule/bank/purchase/detail/" + code + '?code=' + procode + '&type=' + type}><Icon type="file-text" className='rule-icon' />查看规则</Link>
						</Col>
					</Row>
					<Row className="row-content">
						<Col span={12} className="rule-p">
