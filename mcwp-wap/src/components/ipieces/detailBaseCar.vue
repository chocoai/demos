    ...
    <div class="base-container">
      ...
      <div class="base-content" v-if="loanCustomer">
        ...
        <p class="col-p">
          ...
          <span class="content-span">{{loanCustomer.repaymentPeriodText&&loanCustomer.repaymentPeriodText +'期' || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">所购车型:</span>
          <span class="content-span">{{loanCustomer.carModel || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">车辆指导价:</span>
          <span class="content-span">{{Utils.field(loanCustomer, 'carGuidePrice', '万元')}}</span>
        </p>
        <p class="col-p">
...
export default {
  ...
  data () {
    return {
      ...
      Config: Config,
      Utils,
      personPic: [...this.picInfo[Config.bizType.loanPerson], ...this.picInfo[Config.bizType.loanCar] || [], ...this.picInfo[Config.bizType.loanGuarantee] || [], ...this.picInfo[Config.bizType.loanFamily] || [], ...this.picInfo[Config.bizType.loanSpouse] || [], ...this.picInfo[Config.bizType.loanCoborrower] || [], ...this.picInfo[Config.bizType.loanCarinfo] || []],
