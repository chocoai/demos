<template>
  <div>
    ...
    <div class="base-container" v-if="loanSpouse">
      <p id='customer' class="p-title">配偶信息<img v-if="spousePic && spousePic.length" class="title-pic" src="../../assets/base-top-show.png" @click="showPic(Config.bizType.loanSpouse, spousePic)" /></p>
      <div class="base-content">
        ...
        <p class="col-p">
          <span class="lable-span">学历:</span>
          <span class="content-span exist-result">{{loanSpouse.educationText || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">身份证号:</span>
          <span class="content-span">{{loanSpouse.idCardNo || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">联系方式:</span>
        ...
        <p class="col-p">
          <span class="lable-span">所属行业:</span>
          <span class="content-span">{{loanSpouse.belongIndustryText || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">月收入:</span>
          <span class="content-span">{{loanSpouse.monthIncome && loanSpouse.monthIncome + '元' || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">当前月还贷金额:</span>
          <span class="content-span">{{loanSpouse.monthDebt && loanSpouse.monthDebt + '元' || '未录入'}}</span>
        </p>
        <p class="col-p">
          <span class="lable-span">信用卡汇总额度:</span>
          <span class="content-span">{{loanSpouse.creditcardSumamt && loanSpouse.creditcardSumamt + '元' || '未录入'}}</span>
        </p>
      </div>
    </div>
    <div v-transfer-dom>
